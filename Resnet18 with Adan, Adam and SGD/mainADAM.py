...
# optimizer = Adan(net.parameters(), lr=args.lr, weight_decay=5e-4)
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        data_loading_time.append(t1_end - t1_start)
...
for epoch in range(100):
    ...
    training_time.append(t2_end - t2_start)
    ...
    t3_end = perf_counter()
    total_time.append(t3_end - t3_start)
...
# for i in range(5):
#     print("in epoch ", i, " :" )
#     print("data loading time: ", data_loading_time[i])
#     print("training time: ", training_time[i])
