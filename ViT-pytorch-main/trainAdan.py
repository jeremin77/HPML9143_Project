...
def save_model(args, model):
    ...
    torch.save(model_to_save.state_dict(), './checkpoint/ckpt_Adan.pth')
...
def valid(args, model, writer, test_loader, global_step):
    ...
    test_loss_list.append(eval_losses.val)
...
def train(args, model):
    ...
    optimizer = Adan(model.parameters(), lr = 0.015, weight_decay=args.weight_decay, betas=args.opt_betas, eps = args.opt_eps, max_grad_norm=args.max_grad_norm, no_prox=args.no_prox)
